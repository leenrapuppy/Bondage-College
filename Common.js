...
function GetWorkingLanguageForChapter(Chapter) {
	...
	if ((CurrentLanguageTag == "CN") && ["C000_Intro", "C001_BeforeClass", "C002_FirstClass", "C003_MorningDetention", "C004_ArtClass", "C005_GymClass", "C006_Isolation","C009_Library", "C010_Revenge", "C011_LiteratureClass","C999_Common"].indexOf(Chapter) >= 0) return "CN";
