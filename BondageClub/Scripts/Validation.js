...
function ValidationSanitizeProperties(C, item) {
	...
	if (typeof property.Mode === "string" && ArousalHasAdvancedVibesDisabled(C) && !VibratorModeOptions[VibratorModeSet.STANDARD].includes(VibratorModeGetOption(property.Mode))) {
