...
/**
 * Build a seeded PRNG from a seed.
 *
 * This uses a combination of MurmurHash3 and sfc32 to generate a repeatable
 * random number sequence. Repeatable means that for two equal seeds, the
 * numbers generated by each subsequent call will be the same.
 *
 * @param {string} seed
 * @returns {() => number}
 */
function CommonPRNG(seed) {

	// Code lifted from {@link https://stackoverflow.com/questions/521295/seeding-the-random-number-generator-in-javascript stackoverflow}
	...
	// Hash the seed and use its random sequence to seed the PRNG
