...
function InventoryFuturisticChastityBeltCheckPunish(Item) {
	...
	if (Item.Property.NextShockTime - CurrentTime <= 0 && (Item.Property.PunishOrgasm || (Item.Property.Type && Item.Property.Type.includes("o1"))) && ArousalGetOrgasmStage(Player) > ArousalOrgasmStage.Selecting) {
		// Punish the player if they orgasm
		return "Orgasm";
	}
	return "";
