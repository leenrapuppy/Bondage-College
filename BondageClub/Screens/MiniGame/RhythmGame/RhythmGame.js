...
let RhythmGameInit = {
	...
	RhythmGameLoadingPage : function(){
		if(!RhythmGamePreloadCompleted){
			...
			MainCanvas.fillText('Downloading resources',1000,150);
			MainCanvas.font = '40px Courier';
			MainCanvas.fillText('If it takes too long, your browser may not be supported',1000,250);
			MainCanvas.fillText('Try latest Chrome, FireFox or Safari',1000,300);
		}
		else{
			MainCanvas.font = '70px Courier';
			MainCanvas.fillStyle = '#FFFFFF';
			MainCanvas.globalAlpha = 1;
			MainCanvas.textAlign = 'center';
			MainCanvas.fillText('Press SPACE to begin',1000,150);
		}
		...
		MainCanvas.globalAlpha = 1;
		MainCanvas.textAlign = 'center';
		MainCanvas.fillText('Use S D K L to hit notes',1000,750);
	},
};
