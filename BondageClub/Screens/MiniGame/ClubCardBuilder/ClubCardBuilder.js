...
var ClubCardBuilderCardLimit = 30;
...
function ClubCardBuilderRun() {
	...
	DrawText(TextGet("SelectCards") + (ClubCardBuilderDeckIndex + 1).toString() + " (" + ClubCardBuilderDeckCurrent.length + " / " + ClubCardBuilderCardLimit.toString() + ")", 750, 37, "White", "Black");
...
function ClubCardBuilderClick() {
	...
	if ((ClubCardBuilderDeckIndex != -1) && MouseIn(1780, 5, 90, 90)) return ClubCardBuilderSaveChanges();
