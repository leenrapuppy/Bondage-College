...
let KinkyDungeonEnemies = [
	...
	{name: "SamuraiZombie", bound: "Zombie", playLine: "Zombie", clusterWith: "zombie", tags: KDMapInit(["leashing", "zombie", "melee", "elite", "fireweakness", "unflinching", "ropeRestraints", "ropeRestraints2", "meleeweakness", "hunter"]), evasion: -1, armor: 2, followRange: 1, AI: "hunt",
		...
		terrainTags: {"secondhalf":5, "lastthird":5}, shrines: ["Will"], floors:KDMapInit([0, 11]), dropTable: [{name: "Gold", amountMin: 15, amountMax: 20, weight: 10}]},
	...
	{name: "SummonedSkeleton", bound: "Skeleton", playLine: "Skeleton", clusterWith: "skeleton", tags: KDMapInit(["leashing", "skeleton", "melee", "ropeRestraints", "leatherRestraints", "clothRestraints", "crushweakness"]), ignorechance: 0, armor: 0, followRange: 1, AI: "guard",
	...
	{name: "Mimic", blockVisionWhileStationary: true, tags: KDMapInit(["removeDoorSpawn", "ignoreharmless", "ignorenoSP", "construct", "minor", "melee", "trap", "shackleGag", "crushweakness", "meleeresist", "fireweakness", "electricresist", "chainweakness"]),
		...
		terrainTags: {"rubble": 70, "adjChest": 30, "passage": 14, "illusionRage": 2, "illusionAnger": 2}, allFloors: true, shrines: ["Illusion"],
	...
	{name: "ElementalFire", faction: "Elemental", clusterWith: "fire", bound: "ElementalFire", color: "#FF6200", tags: KDMapInit(["opendoors", "fire", "elemental", "fireimmune", "ranged", "coldweakness", "icesevereweakness", "obsidianRestraints", "shackleRestraints", "leashing", "jail", "search"]), armor: 0, kite: 1.5, followRange: 3, AI: "hunt",
	...
	{name: "ElementalIce", faction: "Elemental", clusterWith: "ice", bound: "ElementalIce", color: "#aaaaff", tags: KDMapInit(["opendoors", "elemental", "ranged", "firesevereweakness", "crushweakness", "coldresist", "iceimmune", "iceRestraints", "leashing", "search"]), armor: 1, kite: 1.5, followRange: 3, AI: "hunt",
	...
	{name: "ElementalWater", faction: "Elemental", clusterWith: "ice", bound: "Elemental", color: "#57ff88", tags: KDMapInit(["opendoors", "ice", "elemental", "ranged", "fireresist", "electricsevereweakness", "latexRestraints", "ropeRestraints", "elite", "leashing", "hunter"]), armor: 0, kite: 1.5, followRange: 3, AI: "hunt", evasion: 0.25, summon: [{enemy: "ElementalIce", range: 2.5, count: 1, chance: 0.6, strict: true}],
		...
		visionRadius: 7, maxhp: 12, minLevel:4, weight:-2, movePoints: 1, convertTiles: [{from: "0", to: "w"}], followLeashedOnly: true,
	...
	{name: "OrbOfLight", clusterWith: "nature", color: "#ffff00", tags: KDMapInit(["opendoors", "ignorenoSP", "nature", "ghost", "ranged", "unstoppable", "coldsevereweakness"]), cohesion: 1.0, cohesionRange: 10,
		...
		terrainTags: {"willAnger":4, "willRage":4}, shrines: ["Will"], allFloors: true, dropTable: [{name: "Nothing", weight: 9}, {name: "ElfCrystal", weight: 3}],
	},
	...
	{name: "Apprentice", faction: "Apprentice", color: "#9563ff", spellWhileParole: true, bound: "Witch", playLine: "Apprentice", tags: KDMapInit(["leashing", "opendoors", "binding", "human", "closedoors", "apprentice", "ranged", "glueweakness", "chainweakness", "tickleweakness", "search"]), followRange: 2,
	...
	{name: "Apprentice2", faction: "Apprentice", color: "#ff1616", bound: "Witch", playLine: "Apprentice", tags: KDMapInit(["leashing", "opendoors", "binding", "human", "conjurer", "closedoors", "apprentice", "ranged", "glueweakness", "chainweakness", "tickleweakness", "search"]), followRange: 2,
		...
		spellCooldownMult: 1, spellCooldownMod: 0, AI: "hunt", visionRadius: 5, maxhp: 8, minLevel:2, weight:6, movePoints: 2, attackPoints: 2, attack: "Spell", attackWidth: 1, attackRange: 1, power: 1, dmgType: "grope", fullBoundBonus: 1,
		terrainTags: {"secondhalf":3, "lastthird":3, "increasingWeight": -1}, allFloors: true, shrines: ["Conjure"],
		dropTable: [{name: "RedKey", weight: 1}, {name: "Nothing", weight: 29}]},
	{name: "ApprenticeSlime", faction: "Apprentice", color: "#FF00FF", bound: "Witch", playLine: "Apprentice", tags: KDMapInit(["leashing", "opendoors", "binding", "human", "conjurer", "closedoors", "apprentice", "ranged", "glueweakness", "chainweakness", "tickleweakness", "search"]), followRange: 2,
