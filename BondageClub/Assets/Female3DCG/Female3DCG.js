...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "MedicalInjector", Category: ["SciFi", "Extreme"], Value: 75, Priority: 46, Time: 8, IsRestraint: false, Attribute: ["InjectItem"], AllowPose: ["Yoked"], HideForPose: ["OverTheHead", "BackBoxTie", "BackElbowTouch", "BackCuffs", "AllFours"], },
			{
...

	{
		...
		Asset: [
			...
			{ Name: "NosePlugs", Category: ["Extreme"], Value: 20, Difficulty: 3, Time: 5, RemoveTime: 5},
