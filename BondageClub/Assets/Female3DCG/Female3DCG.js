...
// Name, Priority, Value, Difficulty, SelfBondage, Time, RemoveTime, Enable, Visible, Random, Wear, IsRestraint, AllowLock, OwnerOnly, LoverOnly, FamilyOnly, Left, Top, DefaultColor, BuyGroup, Prerequisite, Hide, HideItem, everything else
...
var AssetFemale3DCG = [
	...
	// Appearance specific
	{
		...
		Asset: [
			...
			{ Name: "StudentOutfit2", Gender: "F", Prerequisite: ["HasBreasts"], Alpha: [{ Group: ["Panties", "ItemPelvis"], Masks: [[0, 0, 500, 560]] }], Hide: ["ItemHidden"], HideItem: ["ItemArmsLeatherCuffs", "ItemArmsLeatherDeluxeCuffs", "ItemArmsFuturisticCuffs", "ItemArmsOrnateCuffs", "ItemArmsHighStyleSteelCuffs", "ClothLowerLatexSkirt1", "ClothLowerLatexSkirt2", "ClothLowerSkirt1", "ClothLowerSkirt2", "ClothLowerSkirt3", "ClothLowerTennisSkirt1", "ClothLowerClothSkirt1", "ItemNipplesPiercingsRoundPiercing", "ItemNipplesPiercingsNecklacePiercingChain", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemNipplesLactationPump", "ClothLowerTutu", "ClothAccessoryPoncho"] },
			{
			...
			{ Name: "TeacherOutfit1", Gender: "F", Prerequisite: ["HasBreasts"], Hide: ["ItemNeck", "ItemHidden"], HideItem: ["ItemArmsLeatherCuffs", "ItemArmsLeatherDeluxeCuffs", "ItemArmsFuturisticCuffs", "ItemArmsOrnateCuffs", "ItemArmsHighStyleSteelCuffs", "ClothLowerLatexSkirt1", "ClothLowerSkirt1", "ClothLowerSkirt2", "ClothLowerSkirt3", "ClothLowerTennisSkirt1", "ClothLowerClothSkirt1", "ItemNipplesPiercingsRoundPiercing", "ItemNipplesPiercingsNecklacePiercingChain", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemNipplesLactationPump", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper", "ClothAccessoryPoncho", "NecklaceCatsuitCollar", "ItemArmsBondageBra"], AllowPose: ["TapedHands", "BackBoxTie", "BackCuffs", "BackElbowTouch", "Yoked", "Hogtied", "AllFours", "OverTheHead", "KneelingSpread"] },
			...
			{ Name: "Yukata1", Gender: "F", Prerequisite: ["HasBreasts"], Value: 50, HideItem: ["ClothLowerLatexSkirt1", "ClothLowerLatexSkirt2", "ClothLowerTutu", "ClothLowerSkirt1", "ClothLowerSkirt2", "ClothLowerSkirt3", "ClothLowerTennisSkirt1", "ClothLowerClothSkirt1", "ItemNipplesPiercingsRoundPiercing", "ItemNipplesPiercingsNecklacePiercingChain", "ItemArmsLeatherCuffs", "ItemArmsLeatherDeluxeCuffs", "ItemArmsFuturisticCuffs", "ItemArmsOrnateCuffs", "ItemArmsHighStyleSteelCuffs", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemNipplesLactationPump", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"] },
			...
			{ Name: "WeddingDress1", Gender: "F", Prerequisite: ["HasBreasts"], Fetish: ["Lingerie"], Priority: 22, Value: 150, Hide: ["ClothLower", "Garters", "BodyLower", "Panties", "Shoes", "ItemBoots", "RightAnklet", "LeftAnklet", "ItemNipples"], HideItem: ["ItemNipplesPiercingsRoundPiercing", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemLegsLeatherLegCuffs", "ItemLegsLeatherDeluxeLegCuffs", "ItemFeetLeatherDeluxeAnkleCuffs", "ItemLegsFuturisticLegCuffs", "ItemDevicesWoodenHorse", "ItemFeetSpreaderMetal", "ItemFeetHeavySpreaderMetal", "ItemFeetSpreaderDildoBar", "ItemFeetSpreaderVibratingDildoBar", "ItemLegsOrnateLegCuffs", "ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemDevicesSaddleStand", "ItemVulvaWandBelt", "ItemFeetAnkleShackles", "ItemFeetIrish8Cuffs", "ItemFeetHeavyAnkleCuffs", "ItemFeetBallChain", "ItemPelvisDiaperHarness"], AllowPose: ["TapedHands", "BackBoxTie", "BackCuffs", "BackElbowTouch", "Yoked", "Hogtied", "LegsClosed", "Kneel", "KneelingSpread", "AllFours","OverTheHead"] },
			{ Name: "WeddingDress2", Gender: "F", Prerequisite: ["HasBreasts"], Fetish: ["Lingerie"], Priority: 22, Value: 150, Hide: ["ClothLower", "Garters", "BodyLower", "Panties", "Shoes", "ItemBoots", "RightAnklet", "LeftAnklet", "ItemNipples"], HideItem: ["ItemNipplesPiercingsRoundPiercing", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemLegsFuturisticLegCuffs", "ItemLegsLeatherLegCuffs", "ItemLegsLeatherDeluxeLegCuffs", "ItemFeetLeatherDeluxeAnkleCuffs", "ItemDevicesWoodenHorse", "ItemFeetSpreaderMetal", "ItemFeetHeavySpreaderMetal", "ItemFeetSpreaderDildoBar", "ItemFeetSpreaderVibratingDildoBar", "ItemLegsOrnateLegCuffs", "ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemDevicesSaddleStand", "ItemVulvaWandBelt", "ItemFeetAnkleShackles", "ItemFeetIrish8Cuffs", "ItemFeetHeavyAnkleCuffs", "ItemFeetBallChain", "ItemPelvisDiaperHarness"], AllowPose: ["TapedHands", "BackBoxTie", "BackCuffs", "BackElbowTouch", "Yoked", "Hogtied", "OverTheHead", "LegsClosed", "Kneel", "KneelingSpread", "AllFours"] },
			...
			{
				Name: "AdmiralTop", Gender: "F", Prerequisite: ["HasBreasts"], Value: 30, Hide: ["ItemNeck", "ItemHidden"], HideItem: ["ItemArmsLeatherCuffs", "ItemArmsLeatherDeluxeCuffs", "ItemArmsFuturisticCuffs", "ItemArmsOrnateCuffs", "ItemArmsHighStyleSteelCuffs", "ClothLowerLatexSkirt1", "ClothLowerSkirt1", "ClothLowerSkirt2", "ClothLowerSkirt3", "ClothLowerTennisSkirt1", "ClothLowerClothSkirt1", "ItemNipplesPiercingsRoundPiercing", "ItemNipplesPiercingsNecklacePiercingChain", "ItemNipplesLactationPump", "ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ClothAccessoryPoncho", "NecklaceCatsuitCollar", "ItemArmsBondageBra"],
				Layer: [
					{ Name: "Jacket" },
					{ Name: "Trim" },
					{ Name: "Shirt" }
			...
			{ Name: "LeatherBolero", Gender: "F", Prerequisite: ["HasBreasts"], Fetish:["Leather"], Value: 60, Alpha: [{ Group: ["ItemNeck"], Masks: [[185, 215, 130, 65]] }], Expose: ["ItemVulva", "ItemVulvaPiercings", "ItemButt", "ItemNipples", "ItemNipplesPiercings", "ItemBreast", "ItemTorso", "ItemTorso2",], HideItem: ["ItemNeckLeatherCollar", "ItemNeckLeatherDeluxeCollar", "ItemNeckLeatherCollarBell", "ItemNeckLeatherCollarBow", "ItemNeckSlaveCollar", "ItemNeckClubSlaveCollar", "ItemNeckShockCollar", "ItemNeckShockCollarRemote", "ItemNeckBatCollar", "ItemNeckPostureCollar", "ItemNeckSteelPostureCollar", "ItemNeckDogCollar", "ItemNeckSpikeCollar", "ItemNeckHighCollar", "ItemNeckLeatherChoker", "ItemNeckPetCollar", "ItemNeckMaidCollar", "ItemNeckBordelleCollar", "ItemNeckLoveLeatherCollar", "ItemNeckNobleCorsetCollar", "ItemNeckHeartCollar", "ItemNeckHighSecurityCollar", "ItemNeckOrnateCollar", "HighStyleSteelCollar", "ItemNeckSlenderSteelCollar", "ItemNeckHeartLinkChoker", "ItemNeckNeckRope", "ItemNipplesStretchClovers"] },
			{
			...
			},
			{
				...
				Layer: [
					...
					{Name: "HoodDown", HasType: false, Top: 45, Left: 124, AllowModuleTypes: ["rh1"], HideAs: { Group: "ItemHood" }},
					{Name: "HoodFull", HasType: false, Top: 45, Left: 124, AllowModuleTypes: ["rh2"], CopyLayerColor: "HoodDown", HideAs: { Group: "ItemHood" },
						Alpha: [{ Group: ["ItemHood", "ItemHead", "ItemMouth", "ItemMouth2", "ItemMouth3", "Hat", "HairFront", "HairBack", "HairAccessory1", "HairAccessory2", "HairAccessory3", "Mask"], Masks: [[0, 0, 185, 500], [315, 0, 232, 500], [0, 250, 500, 1000], [183,238,14,12], [303,238,14,12]] },], },
					{Name: "HoodLow", HasType: false, Top: 53, Left: 124, AllowModuleTypes: ["lh1"], CopyLayerColor: "HoodDown", HideAs: { Group: "ItemHood" }},
					{Name: "HoodHigh", HasType: false, Top: -3, Left: 122, AllowModuleTypes: ["lh2"], Priority: 55, CopyLayerColor: "HoodDown", HideAs: { Group: "ItemHood" }},
				],
			},
			{
...

	{
		...
		Asset: [
			...
			{
				Name: "BugLegs", Priority: 6, Value: 40, DefaultColor: ["#406A50", "#7F795F"],
				Layer: [
					{ Name: "Legs" },
					{ Name: "Joints", Priority: 5 },
				]
			},
			// Flat Chest Compatible Clothing
		],
...

	{
		...
		Asset: [
			...
			{ Name: "NecklaceRope", Priority: 29, Value: -1, Left: 220, Top: 200, DefaultColor: "#956B1C", BuyGroup: "HempRope", CraftGroup: "HempRope", ParentGroup: null, Extended: true, AllowTighten: true },
...

	{
		...
		Asset: [
			...
			{ Name: "Jeans1", Priority: 23, Hide: ["ItemVulvaPiercings", "Garters", "Pussy", "ItemVulva", "Panties"], HideItem: ["ItemButtAnalBeads2", "SocksSocksFur", "SocksSocks6", "ItemVulvaHempRopeBelt", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo", "ItemVulvaClitSuctionCup", "ItemVulvaHeavyWeightClamp", "ItemVulvaClitAndDildoVibratorbelt", "ItemVulvaShockDildo", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "PantiesJockstrap", "PantiesBriefs"] },
			...
			{ Name: "Jeans2", Priority: 23, Value: 20, Hide: ["ItemVulvaPiercings", "Garters", "ItemVulva", "Pussy"], HideItem: ["ItemButtAnalBeads2", "SocksSocksFur", "SocksSocks6", "ItemVulvaHempRopeBelt", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo", "ItemVulvaClitSuctionCup", "ItemVulvaHeavyWeightClamp", "ItemVulvaClitAndDildoVibratorbelt", "ItemVulvaShockDildo", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "PantiesJockstrap", "PantiesBriefs"] },
			...
			{ Name: "PencilSkirt", Gender: "F", Prerequisite: ["HasVagina"], Fetish: ["Leather"], Value: 60, Left: 105, Top: 380, HideItem: ["ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemLegsNylonRope", "ItemLegsHempRope", "ItemLegsLeatherBelt", "ItemLegsSturdyLeatherBelts", "ItemLegsDuctTape", "ItemLegsLeatherLegCuffs", "ItemLegsLeatherDeluxeLegCuffs", "ItemLegsOrnateLegCuffs", "ItemLegsFuturisticLegCuffs", "ItemLegsZipties", "ItemLegsChains", "ItemFeetSpreaderMetal", "ItemFeetHeavySpreaderMetal", "ItemFeetSpreaderDildoBar", "ItemFeetSpreaderVibratingDildoBar", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper", "GartersTentacles", "ItemLegsTentacles"], SetPose: ["LegsClosed"], AllowActivePose: ["Kneel"], WhitelistActivePose: ["BaseLower", "Kneel"], HideForPose: ["KneelingSpread"], Attribute: ["Skirt"], },
			...
			{ Name: "ShortPencilSkirt", Gender: "F", Prerequisite: ["HasVagina"], Fetish: ["Leather"], Value: 50, Left: 105, Top: 380, Alpha: [{ Group: ["Panties", "ItemPelvis"], Masks: [[0, 0, 180, 600], [320, 0, 180, 600], [0, 0, 500, 480]] }], HideItem: ["ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "ItemFeetSpreaderMetal", "ItemFeetHeavySpreaderMetal", "ItemFeetSpreaderDildoBar", "ItemFeetSpreaderVibratingDildoBar"], SetPose: ["LegsClosed"], AllowActivePose: ["Kneel"], WhitelistActivePose: ["BaseLower", "Kneel"], HideForPose: ["KneelingSpread"], Attribute: ["Skirt"], },
			{
			...
			},
			{
				...
				Hide: ["ItemFeet"],
				HideItem: ["ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"],
				HideItemExclude: ["ItemFeetLeatherAnkleCuffs", "ItemFeetLeatherDeluxeAnkleCuffs", "ItemFeetSteelAnkleCuffs", "ItemFeetEscortAnkleCuffs", "ItemFeetFuturisticAnkleCuffs", "ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetWoodenCuffs", "ItemFeetHeavySpreaderMetal", "ItemFeetHeavyAnkleCuffs"],
			...
			{
				Name: "CrossSkirt", Value: 60, AllowPose: ["KneelingSpread"], HideItem: ["ItemDevicesStrapOnSmooth", "ItemDevicesStrapOnStuds"], Expose: ["ItemVulva", "ItemVulvaPiercings", "ItemButt"], Attribute: ["Skirt"], Layer: [
					{ Name: "Base" },
					{ Name: "Belt" },
					{ Name: "Cross" },
					{ Name: "Metal" },
...

	{
		...
		Asset: [
			...
			{ Name: "HarnessBra1", Gender: "F", Prerequisite: ["HasBreasts"], Fetish: ["Leather"], Priority: 20, Value: 30, BuyGroup: "HarnessBra1", Expose: ["ItemNipples", "ItemBreast", "ItemNipplesPiercings"], Attribute: ["CanAttachMittens"], },
...

	{
		...
		Asset: [
			...
			{
				Name: "MaleCatsuitPanties", Gender: "M", Prerequisite: ["HasPenis"], Attribute: ["GenitaliaCover"], DefaultColor: ["Default", "#000000"], Fetish: ["Latex"], Value: -1, BuyGroup: "Catsuit", Left: 95, Top: 380, DynamicGroupName: "SuitLower", Hide: ["ItemVulvaPiercings", "Pussy", "ItemVulva"], HideItem: ["SocksPantyhose1"],
				Layer: [
					{ Name: "Base", HasType: false },
					{ Name: "Bulge", CopyLayerColor: "Base", HasType: false, AllowTypes: ["Bulge", "Lock"] },
					{ Name: "Penis", CopyLayerColor: "Base", HasType: false, AllowTypes: ["SkinTight"] },
			...
			{
				Name: "Briefs", Gender: "M", Prerequisite: ["HasPenis"], Attribute: ["GenitaliaCover"], Value: 20, Hide: ["Pussy", "ItemVulva", "ItemVulvaPiercings"],
			...
			{
				Name: "Jockstrap", Gender: "M", Prerequisite: ["HasPenis"], Attribute: ["GenitaliaCover"], Value: 30, Hide: ["Pussy", "ItemVulva", "ItemVulvaPiercings"],
	...
	},
	{
		...
		PreviewZone: [0, 450, 500, 500],
		Asset: [
			{ Name: "Socks0", HideForPose: ["KneelingSpread"], Random: false },
			{ Name: "Socks1", HideForPose: ["KneelingSpread"], Random: false },
			{ Name: "Socks2", HideForPose: ["KneelingSpread"], Random: false },
			{ Name: "Socks3", Random: false },
			{ Name: "Socks4", Random: false },
			{ Name: "Socks5", Random: false },
			{ Name: "Stockings1", Fetish: ["Nylon"], BuyGroup: "Stockings1", Random: false},
			{ Name: "Stockings2", Fetish: ["Nylon"], BuyGroup: "Stockings2", Random: false},
			{ Name: "Stockings3", Fetish: ["Nylon"], Value: 10, BuyGroup: "Stockings3", Random: false},
			{ Name: "Stockings4", Fetish: ["Nylon"], Value: 10, BuyGroup: "Stockings4", Random: false},
			{
				Name: "Socks6", Fetish: ["Nylon"], Value: 25, BuyGroup: "Socks6", Random: false,
				Layer: [
					{ Name: "Sock" },
					{ Name: "Frill" }
				]
			...
			{
				Name: "SocksFur", Fetish: ["Nylon"], Value: 40, DefaultColor: ["#8c2331", "Default"], HideForPose: ["KneelingSpread"], BuyGroup: "SocksFur", Random: false,
				Layer: [
					{ Name: "Fabric" },
					{ Name: "Fur" }
				]
			...
			{
				Name: "SocksStriped1", Value: 10, HideForPose: ["KneelingSpread"], BuyGroup: "SocksStriped1", Random: false, Layer: [
					{ Name: "Light" },
					{ Name: "Dark" },
				]
			},
			{ Name: "LatexSocks1", Fetish: ["Latex"], Value: 30, BuyGroup: "LatexSocks1", Random: false },
			{ Name: "FootlessSocks1", Value: 15, BuyGroup: "FootlessSocks1", Random: false },
			{ Name: "LeatherSocks1", Fetish: ["Leather"], Value: 20, HideForPose: ["KneelingSpread"], BuyGroup: "LeatherSocks1", Random: false },
			{ Name: "CowPrintedSocks", Fetish: ["Nylon"], Value: 15, BuyGroup: "CowPrintedSocks", Random: false },
			{
				Name: "HaremStockings", Fetish: ["Nylon"], Value: 25, BuyGroup: "HaremStockings", Random: false,
				Layer: [
					{ Name: "Fabric" },
					{ Name: "Bands" }
				]
	...
	},
	{
		...
		Asset: [
			...
			{ Name: "SneakersSport", Height: 3, HideForPose: ["Kneel", "KneelingSpread"],
			    DefaultColor: ["Default", "#3A271E", "#50463B"],
				Layer: [
					{ Name: "Main", AllowColorize: true, HideForPose: ["Hogtied"]},
					{ Name: "Front", AllowColorize: true},
					{ Name: "Laces", AllowColorize: true, HideForPose: ["Hogtied"]}
				]
			},
			...
			{ Name: "AnkleBoots1", Height: 9, HideForPose: ["Kneel", "KneelingSpread"], HideItem: ["LeftAnkletRibbon1", "RightAnkletRibbon1"],
				DefaultColor: ["#874D4D", "#5A3A3A", "#976E6E"],
				Layer: [
					{ Name: "Shoes", AllowColorize: true, HideForPose: ["Hogtied"]},
					{ Name: "Sides", AllowColorize: true, HideForPose: ["Hogtied"]},
					{ Name: "Laces", AllowColorize: true}
				]
			},
			{ Name: "MistressBoots", Fetish: ["Leather"], Value: -1, HideItem: ["SocksSocks4", "SocksSocks5", "LeftAnkletRibbon1", "RightAnkletRibbon1"], Alpha: [{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Masks: [[75, 875, 350, 200]] }], Height: 35, HideForPose: ["KneelingSpread"] },
			{ Name: "PonyBoots", Fetish: ["Pony"], Value: -1, Alpha: [{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Masks: [[75, 875, 350, 200]] }], Height: 35, HideForPose: ["KneelingSpread"] },
			...
			{ Name: "BarefootSandals1", Hide: ["Socks", "SocksRight", "SocksLeft"], Value: 10, HideForPose: ["Kneel", "KneelingSpread"], },
			...
			{ Name: "DeluxeBoots", Fetish: ["Leather"], Value: -1, HideItem: ["LeftAnkletRibbon1", "RightAnkletRibbon1"], Alpha: [{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Masks: [[180, 900, 50, 100], [280, 900, 50, 100]] }], DefaultColor: ["#9F0D0D", "#700A0A", "#700A0A", "#9F0D0D"], Height: 35, HideForPose: ["KneelingSpread"],
				Layer: [
			...
			{ Name: "AnkleStrapShoes", Priority: 22, Value: 30, HideForPose: ["Kneel", "KneelingSpread"], Alpha: [{ Group: ["Socks", "SocksRight", "SocksLeft"], Masks: [[130, 925, 270, 130]] }], Height: 4 },
			...
			},
			{
				...
				Alpha: [
					{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Masks: [[0, 805, 500, 195]] },
					{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Pose: ["LegsClosed"], Masks: [[0, 795, 500, 205]] },
...

	{
		...
		Asset: [
			...
			},
			{
				...
				Layer:[
					{Name: "Cape", AllowTypes: [""]},
					{Name: "CapeThin", AllowTypes: ["Tight"], CopyLayerColor: "Cape"},
					{Name: "Base", AllowTypes: [""]},
					{Name: "BaseThin", AllowTypes: ["Tight"], CopyLayerColor: "Base"},
					{Name: "Collar", AllowTypes: [""]},
					{Name: "CollarThin", AllowTypes: ["Tight"], CopyLayerColor: "Collar"},
					{Name: "Cowl", AllowTypes: [""]},
					{Name: "CowlThin", AllowTypes: ["Tight"], CopyLayerColor: "Cowl"},
					{Name: "Back", Priority: 5, CopyLayerColor: "Base", AllowTypes: [""]},
					{Name: "BackThin", Priority: 5, CopyLayerColor: "Base", AllowTypes: ["Tight"]},
				],
			},
			{
			...
			},
			{
				...
				Layer:[
					...
					{Name:"Stripes2", CopyLayerColor: "Stripes1", AllowModuleTypes: ["p2"]},
					{Name:"Triangle", CopyLayerColor: "Stripes1", AllowModuleTypes: ["p3"]},
					{Name:"Cowprint", CopyLayerColor: "Stripes1", AllowModuleTypes: ["p4"]},
...

	{
		...
		Asset: [
			...
			{ Name: "LatexShortGloves", Gender: "F", Prerequisite: ["HasBreasts"], Fetish: ["Latex"], Value: 75, Top: 8, HideForPose: ["BackElbowTouch", "BackBoxTie"] },
		...
		Asset: [
			{
				...
				Layer: [
					...
					{ Name: "FaceDermalLeft", HasType: false, AllowModuleTypes: ["f1","f3","f9","f10","f11"] },
					{ Name: "FaceDermalRight", HasType: false, CopyLayerColor: "FaceDermalLeft", AllowModuleTypes: ["f1","f2","f9","f10","f11"] },
					{ Name: "FaceBridge", HasType: false, CopyLayerColor: "FaceDermalLeft", AllowModuleTypes: ["f4","f8","f9","f11"] },
					{ Name: "FaceMonroeRight", HasType: false, CopyLayerColor: "FaceDermalLeft", AllowModuleTypes: ["f5"] },
					{ Name: "FaceMonroeLeft", HasType: false, CopyLayerColor: "FaceDermalLeft", AllowModuleTypes: ["f6"] },
					{ Name: "FaceCheeks", HasType: false, CopyLayerColor: "FaceDermalLeft", AllowModuleTypes: ["f7","f8","f10","f11"] },
				]
			},
		],
	},
...

	{
		...
		Asset: [
			...
			{ Name: "HairBack6b" },
			{
				...
				Layer: [
					{Name: "MainLeft", Priority: 32},
					{Name: "BehindLeft", CopyLayerColor: "MainLeft"},
					{Name: "MainRight", Priority: 32},
	...
	// Item specific
	{
		...
		Asset: [
			{ Name: "NylonRope", Fetish: ["Rope", "Nylon"], Value: 30, Time: 15, BuyGroup: "NylonRope", SetPose: ["LegsClosed"], Audio: "RopeShort", Extended: true, AllowActivePose: ["Kneel"], DynamicBeforeDraw: true, AllowTighten: true,
			...
			{ Name: "HeavyAnkleCuffs", Fetish: ["Metal"], Priority: 24, Value: 25, Difficulty: 7, Time: 10, RemoveTime: 5, AllowLock: true, Audio: "CuffsMetal", SetPose: ["LegsClosed"], AllowActivePose: ["Kneel"],
				Layer: [
					{ Name: "Frame" },
					{ Name: "Cuffs" },
				],
			...
			{ Name: "LeatherDeluxeAnkleCuffs", Fetish: ["Leather"], Priority: 24, Value: 50, Difficulty: 6, Time: 10, Random: false, AllowLock: true, DrawLocks: false, AllowTighten: true, AllowPose: ["LegsClosed", "Spread", "KneelingSpread"], Effect: ["CuffedFeet"], Extended: true, AllowActivePose: ["Kneel", "KneelingSpread"], HasType: false, RemoveItemOnRemove: [{ Name: "X-Cross", Group: "ItemDevices" }], FreezeActivePose: [],
				DefaultColor: ["Default", "Default", "#612C2C", "Default"],
				Layer: [
					{ Name: "Chain", ParentGroup: null, AllowTypes: ["Chained"]},
					{ Name: "Cuffs" },
					{ Name: "Rings" },
					{ Name: "Buckets" },
					{ Name: "Lock", LockLayer: true, ParentGroup: null, AllowColorize: true },
				]
			},
			{
			...
			{ Name: "EscortAnkleCuffs", Fetish: ["Metal"], Priority: 24, Value: 30, Difficulty: 6, Time: 10, Random: false, AllowLock: true, DrawLocks: false, Audio: "MetalCuffs", AllowPose: ["LegsClosed", "Spread"], HideForPose: ["Kneel"], Effect: ["CuffedFeet", "Lock", "Slow"], AllowActivePose: ["Kneel"], HasType: false, RemoveItemOnRemove: [{ Name: "X-Cross", Group: "ItemDevices" }], FreezeActivePose: [],
				Layer: [
					{ Name: "Cuffs" }
				]
			},
			...
			{
				Name: "HighStyleSteelAnkleCuffs", Fetish: ["Metal"], Priority: 24, Value: 90, Difficulty: 6, Time: 10, Random: false, AllowLock: true, Audio: "CuffsMetal", AllowPose: ["LegsClosed", "Spread"], Effect: ["CuffedFeet"], Extended: true, AllowActivePose: ["Kneel"], HasType: false, RemoveItemOnRemove: [{ Name: "X-Cross", Group: "ItemDevices" }], FreezeActivePose: [],
				Layer: [
					{ Name: "Chain", ParentGroup: null, AllowTypes: ["Chained"]},
					{ Name: "Cuffs" },
					{ Name: "Panel" },
			...
			{ Name: "HeavySpreaderMetal", Fetish: ["Metal"], Priority: 24, Value: 50, Difficulty: 7, Time: 10, Random: false, AllowLock: true, Prerequisite: ["NotKneeling", "LegsOpen"], Block: ["ItemLegs"], AllowActivityOn: ["ItemLegs"], Extended: true, RemoveAtLogin: true, SetPose: ["LegsOpen"],
				Layer: [
					{ Name: "Frame" },
					{ Name: "Cuffs" },
				],
			...
			},
			{
				...
				AllowPose: ["Spread"],
				SetPose: ["LegsClosed"],
				HideItem: ["ShoesBoots1", "ShoesAnkleBoots1", "ShoesFlippers", "ShoesFuzzyBoots", "ShoesThighHighLatexHeels", "ShoesWoollyBootsTall", "ItemBootsHighThighBoots", "ItemBootsThighHighLatexHeels", "ClothLowerPajama1"],
				DefaultColor: ["#c43ba4", "#b832b6", "#9221ba"],
				Layer: [
...

	{
		...
		Asset: [
			{ Name: "NylonRope", Fetish: ["Rope", "Nylon"], Value: 30, Time: 10, BuyGroup: "NylonRope", Audio: "RopeShort", SetPose: ["LegsClosed"], AllowPose: ["Kneel", "KneelingSpread"], AllowActivePose: ["Kneel", "LegsClosed"], FreezeActivePose: [], Extended: true, AllowTighten: true,
				DefaultColor: ["#CCCCCC","#CCCCCC", "#CCCCCC"],
				Layer: [
			...
			{
				Name: "LeatherDeluxeLegCuffs", Fetish: ["Leather"], Priority: 24, Value: 10, Difficulty: 6, Time: 10, Random: false, AllowLock: true, DrawLocks: false, AllowTighten: true, AllowPose: ["Kneel", "LegsClosed", "KneelingSpread"], Effect: ["CuffedLegs"], Extended: true, AllowActivePose: ["Kneel", "KneelingSpread"], FreezeActivePose: [], HasType: false,
				DefaultColor: ["Default", "Default", "#612C2C", "Default"],
				Layer: [
					{ Name: "Chain", ParentGroup: null, AllowTypes: ["Chained"]},
					{ Name: "Cuffs" },
					{ Name: "Rings" },
					{ Name: "Buckets" },
					{ Name: "Lock", LockLayer: true, AllowColorize: true },
				]
			},
			...
			{
				Name: "LegBinder", Fetish: ["Latex"], Value: 80, Difficulty: 15, Time: 30, RemoveTime: 20, AllowLock: true, AllowTighten: true, DefaultColor: ["#222", "Default"], Prerequisite: ["NotSuspended", "NotHogtied", "CanCloseLegs"], Hide: ["Shoes", "Socks", "SocksRight", "SocksLeft", "ClothLower", "Garters"], HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemBootsThighHighLatexHeels", "ItemBootsHighThighBoots", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"], SetPose: ["LegsClosed"], Effect: ["Prone", "Slow"], Block: ["ItemFeet"], AllowActivePose: ["Kneel"],
				Layer: [
					{ Name: "Latex" },
					{ Name: "Belts" },
				]
			...
			{
				Name: "HobbleSkirt", Fetish: ["Latex"], Value: 125, Difficulty: 15, Time: 30, RemoveTime: 20, AllowLock: true, AllowTighten: true, DefaultColor: ["#222", "Default"], Prerequisite: ["NotSuspended", "NotHogtied", "CanCloseLegs"], Hide: ["Shoes", "Socks", "SocksRight", "SocksLeft", "ClothLower", "Garters"], HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemBootsThighHighLatexHeels", "ItemBootsHighThighBoots", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"], SetPose: ["LegsClosed"], Effect: ["Prone", "Slow"], Block: ["ItemPelvis", "ItemFeet", "ItemVulva", "ItemVulvaPiercings", "ItemButt"], AllowActivePose: ["Kneel"],
				Layer: [
					{ Name: "Latex" },
					{ Name: "Belts" }
				]
			},
			{ Name: "SeamlessLegBinder", Value: 80, Difficulty: 15, Time: 30, RemoveTime: 20, AllowLock: true, DefaultColor: "#222222", Prerequisite: ["NotSuspended", "NotHogtied", "CanCloseLegs"], Hide: ["Shoes", "Garters"], HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemBootsThighHighLatexHeels", "ClothLowerPajama1", "SocksSocks6", "SocksSocksFur", "ItemBootsHighThighBoots", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"], SetPose: ["LegsClosed"], Effect: ["Prone", "Slow"], Block: ["ItemFeet"], AllowActivePose: ["Kneel"] },
			{ Name: "SeamlessHobbleSkirt", Value: 125, Difficulty: 15, Time: 30, RemoveTime: 20, AllowLock: true, DefaultColor: "#222222", Prerequisite: ["NotSuspended", "NotHogtied", "CanCloseLegs"], Hide: ["Shoes", "Garters"], HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemBootsThighHighLatexHeels", "ClothLowerPajama1", "ClothLowerShorts1", "ClothLowerJeans1", "ClothLowerJeans2", "ClothLowerLatexPants1", "ClothLowerLeggings1", "ClothLowerLeggings2", "ClothLowerMistressBottom", "ClothLowerPencilSkirt", "SocksSocks6", "SocksSocksFur", "ItemBootsHighThighBoots", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"], SetPose: ["LegsClosed"], Effect: ["Prone", "Slow"], Block: ["ItemPelvis", "ItemFeet", "ItemVulva", "ItemVulvaPiercings", "ItemButt"], AllowActivePose: ["Kneel"] },
...

	{
		...
		Asset: [
			...
			{ Name: "DoubleEndDildo", Gender: "F", Value: 15, Time: 10, DefaultColor: ["#624662"], Effect: ["FillVulva"], Prerequisite: ["AccessVulva", "HasVagina"], AllowPose: [], ExpressionTrigger: [{ Name: "Medium", Group: "Blush", Timer: 20 }], AllowActivity: ["PenetrateItem"], HasType: true, Extended: true, },
			{
				...
				Layer: [
					{ Name: "Straight", HasType: false, AllowTypes: [""] },
			...
			{
				Name: "PlasticChastityCage1", Gender: "M", Prerequisite: ["AccessVulva", "HasPenis", "AccessFullPenis"], Difficulty: 50, Value: 20, Effect: ["Chaste"], Hide: ["Pussy"], Attribute: ["CageTechno"],
				AllowPose: [],
			...
			{
				Name: "PlasticChastityCage2", Gender: "M", Prerequisite: ["AccessVulva", "HasPenis", "AccessFullPenis"], Value: 20, Difficulty: 50, Effect: ["Chaste"], Hide: ["Pussy"], Attribute: ["CagePlastic2"],
				AllowPose: [],
				AllowLock: true, DrawLocks: false,
			...
			{
				Name: "TechnoChastityCage", Gender: "M", Prerequisite: ["AccessVulva", "HasPenis", "AccessFullPenis"], Category: ["SciFi"], Value: 50, Difficulty: 50, Effect: ["Chaste"], Hide: ["Pussy"], Attribute: ["CageTechno"],
				AllowPose: [],
				AllowLock: true, DrawLocks: false,
			...
			{
				Name: "FlatChastityCage", Gender: "M", Fetish: ["Metal"], Prerequisite: ["AccessVulva", "HasPenis", "AccessFullPenis"], Value: 25, Difficulty: 50, Effect: ["Chaste"], Hide: ["Pussy"], Attribute: ["CageFlat"],
				AllowPose: [],
				AllowLock: true, DrawLocks: false,
...

	{
		...
		Asset: [
			...
			{ Name: "ChastityClitShield", Gender: "F", Fetish: ["Metal"], Value: 70, Difficulty: 50, Time: 30, RemoveTime: 30, AllowLock: true, DrawLocks: false, Prerequisite: ["AccessVulva", "HasVagina", "CanCoverVulva"],  HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo"], Effect: ["Chaste"], Block: ["ItemVulva"], ExpressionTrigger: [{ Name: "Closed", Group: "Eyes", Timer: 5 }, { Name: "Soft", Group: "Eyebrows", Timer: 5 }] },
			{ Name: "HighSecurityVulvaShield", Gender: "F", Fetish: ["Metal"], Value: 100, Difficulty: 99, Time: 60, RemoveTime: 200, AllowLock: true, DrawLocks: false, Prerequisite: ["AccessVulva", "HasVagina", "CanCoverVulva"],  HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo"], Effect: ["Chaste"], Block: ["ItemVulva"], ExpressionTrigger: [{ Name: "Closed", Group: "Eyes", Timer: 5 }, { Name: "Soft", Group: "Eyebrows", Timer: 5 }] },
...

	{
		...
		Asset: [
			{ Name: "StraponPanties", Gender: "F", Fetish: ["Latex"], Value: -1, Time: 15, DefaultColor: "#505050", Prerequisite: ["AccessCrotch", "HasVagina"], AllowActivity: ["PenetrateItem"], Bonus: "KidnapBruteForce", HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"] },
			{ Name: "LeatherChastityBelt", Gender: "F", Fetish: ["Leather"], ParentGroup: null, Value: 30, Difficulty: 8, Time: 20, RemoveTime: 10, AllowLock: true, AllowTighten: true, Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Layer: [
				{ Name: "Belt" },
				{ Name: "Studs" },
				{ Name: "Locks", LockLayer: true }
			] },
			{ Name: "SleekLeatherChastityBelt", Gender: "F", Fetish: ["Leather"], Value: 45, Difficulty: 11, Time: 20, RemoveTime: 10, AllowLock: true, AllowTighten: true, Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }] },
			{ Name: "StuddedChastityBelt", Gender: "F", Fetish: ["Leather", "Metal"], Value: 60, Difficulty: 14, Time: 20, RemoveTime: 10, AllowLock: true, AllowTighten: true, Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Extended: true, HasType: false },
			{ Name: "MetalChastityBelt", Attribute: ["GenitaliaCover"], Fetish: ["Metal"], ParentGroup: null, Value: 100, Difficulty: 20, Time: 20, RemoveTime: 10, DrawLocks: false, AllowLock: true, Audio: "CuffsMetal", Prerequisite: ["AccessCrotch", "CanCoverVulva"], Hide: ["ItemVulva", "Pussy"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Extended: true, HasType: false, Layer: [
				{ Name: "Belt" },
			...
			{ Name: "FuturisticChastityBelt", Gender: "F", Category: ["SciFi"], Fetish: ["Metal"], Value: 170, BuyGroup: "FuturisticChastityBelt",
				...
				Audio: "FuturisticApply", Prerequisite: ["AccessCrotch", "HasVagina"], Attribute: ["FuturisticRecolor"],
			...
			},
			{
				...
				Layer: [
					...
					{ Name: "Band", AllowColorize: true, ParentGroup: null, ShowForAttribute: ["PussyLayer"]},
					{ Name: "BandMale", CopyLayerColor: "Band", ParentGroup: null, ShowForAttribute: ["PenisLayer"]},
					{ Name: "Plug2", AllowColorize: true, ParentGroup: null, ShowForAttribute: ["PussyLayer"]},
					{ Name: "Plug1", AllowColorize: true, ParentGroup: null, ShowForAttribute: ["PussyLayer"]},
					{ Name: "Lock", LockLayer: true,AllowColorize: true, HasType: false, ParentGroup: null},
				]
			},
			{
				Name: "OrnateChastityBelt", Fetish: ["Metal"], Attribute: ["GenitaliaCover"], Value: 200, Difficulty: 50, Time: 20, RemoveTime: 10, AllowLock: true, Audio: "CuffsMetal", Prerequisite: ["AccessCrotch", "CanCoverVulva"], Hide: ["ItemVulva", "Pussy"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Extended: true, HasType: false,
				Layer: [
					{ Name: "Belt" },
					{ Name: "Gems" }
				]
			},
			{ Name: "SteelChastityPanties", Gender: "F", Fetish: ["Metal"], Value: 150, Difficulty: 50, Time: 50, RemoveTime: 60, AllowLock: true, Audio: "CuffsMetal", Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], Hide: ["ItemVulva", "ItemVulvaPiercings"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }] },
			{ Name: "HarnessPanties1", Gender: "F", Fetish: ["Leather"], Priority: 19, Value: 35, Difficulty: 8, Time: 10, RemoveTime: 15, AllowLock: true, AllowTighten: true, Left: 110, Top: 395, BuyGroup: "HarnessPanties1", Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], AllowPose: ["LegsClosed", "Kneel", "KneelingSpread"], Expose: ["ItemVulva", "ItemVulvaPiercings", "ItemButt"] },
			{ Name: "HarnessPanties2", Gender: "F", Fetish: ["Leather"], Priority: 19, Value: 40, Difficulty: 9, Time: 10, RemoveTime: 15, AllowLock: true, AllowTighten: true, Left: 85, Top: 395, BuyGroup: "HarnessPanties2", Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], AllowPose: ["LegsClosed", "Kneel", "KneelingSpread", "Spread"], Expose: ["ItemVulva", "ItemVulvaPiercings", "ItemButt"], DrawLocks: false },
			{ Name: "LeatherStrapPanties1", Gender: "F", Fetish: ["Leather"], Value: 20, Difficulty: 5, Time: 20, RemoveTime: 10, AllowLock: true, AllowTighten: true, Left: 150, Top: 395, BuyGroup: "LeatherStrapPanties1", Prerequisite: ["AccessCrotch", "HasVagina", "CanCoverVulva"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }] },
			{
				Name: "LoveChastityBelt", Gender: "F", Fetish: ["Metal"], Value: 250, Difficulty: 50,
				Time: 20, RemoveTime: 10, OwnerOnly: true, Prerequisite: ["AccessCrotch", "HasVagina"],
				HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"],
			...
			{ Name: "HempRope", Gender: "F", Fetish: ["Rope"], Value: 60, Difficulty: 3, Time: 20, RemoveTime: 25, DefaultColor: "#956B1C", BuyGroup: "HempRope", Audio: "RopeShort", Prerequisite: ["AccessTorso", "HasVagina"], AllowPose: ["LegsClosed", "Kneel", "KneelingSpread"], Extended: true, AllowTighten: true },
			{ Name: "DiaperHarness", Gender: "F", Category: ["ABDL"], Prerequisite: ["HasVagina", "CanCoverVulva"], Fetish: ["Leather", "ABDL"], Priority: 24, Value: 65, Difficulty: 50, Time: 25, RemoveTime: 30, AllowLock: true, Left: 150, Top: 395, Hide: ["ItemVulva", "ItemVulvaPiercings"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }] },
			...
			{ Name: "Ribbons", Gender: "F", Fetish: ["Lingerie"], Value: 30, Difficulty: 3, Time: 10, RemoveTime: 5, BuyGroup: "Ribbon", Prerequisite: ["AccessCrotch", "HasVagina"], Extended: true },
			{
				Name: "BulkyDiaper", BuyGroup: "BulkyDiapers", Priority: 25, Category: ["ABDL"], Fetish: ["ABDL"], Attribute: ["GenitaliaCover"], Random: false, Value: 30, Difficulty: 50, Time: 5, RemoveTime: 5, AllowLock: true, DrawLocks: false, Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], DefaultColor:["#688599", "#808080", "#8c7384", "#BF3F97"], AllowPose: ["LegsClosed", "Kneel"], HideForPose: ["KneelingSpread", "Hogtied", "AllFours"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo", "ItemVulvaClitSuctionCup", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ClothMistressBottom", "ClothShorts1"], Left: 49, Top: 360, SetPose: ["LegsOpen"], AllowActivePose: ["Kneel"], WhitelistActivePose: ["BaseLower", "Kneel"],
				Layer: [
					{ Name: "Base" },
					{ Name: "CrotchPiece" },
					{ Name: "WaistBand" },
			...
			{
				Name: "PoofyDiaper", BuyGroup: "PoofyDiapers", Priority: 25, Category: ["ABDL"], Fetish: ["ABDL"], Attribute: ["GenitaliaCover"], Random: false, Value: 30, Difficulty: 50, Time: 5, RemoveTime: 5, AllowLock: true, DrawLocks: false, Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], DefaultColor:["#9763A6", "#658AA6", "#997391", "#a916cc"], AllowPose: ["LegsClosed", "Kneel"], HideForPose: ["KneelingSpread", "Hogtied", "AllFours"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaInflatableVibeDildo", "ItemVulvaClitSuctionCup", "ItemVulvaPiercingsVibeHeartClitPiercing", "ItemVulvaPiercingsClitRing", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ClothMistressBottom", "ClothShorts1"], Left: 49, Top: 360, SetPose: ["LegsOpen"], AllowActivePose: ["Kneel"], WhitelistActivePose: ["BaseLower", "Kneel"], Extended: true,
				Layer: [
					{ Name: "Base", HasType: false, AllowTypes: [""] },
					{ Name: "PoofyBase", CopyLayerColor: "Base", HasType: false, AllowTypes: ["Poofy"] },
					{ Name: "CrotchPatch", HasType: false },
			...
			{ Name: "HybridChastityBelt", Gender: "F", Fetish: ["Leather", "Metal"], ParentGroup: null, Value: 120, Difficulty: 8, Time: 20, RemoveTime: 10, AllowLock: true, AllowTighten: true, Prerequisite: ["AccessCrotch", "HasVagina"], HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsChastityClitShield", "ItemVulvaPiercingsHighSecurityVulvaShield"], Effect: ["Chaste"], Block: ["ItemVulva", "ItemButt", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Layer: [
				{ Name: "Belt" },
				{ Name: "CrotchPlate" },
				{ Name: "Rivets" },
				{ Name: "Lock", LockLayer: true }
			] },
			{
				...
				Extended: true, DynamicScriptDraw: true, DynamicAfterDraw: true, AllowLock: true, DrawLocks: false, Prerequisite: ["AccessCrotch", "HasVagina"], AllowEffect: ["Chaste"],
...

	{
		...
		Asset: [
			{ Name: "NylonRopeHarness", Gender: "F", Fetish: ["Rope", "Nylon"], Value: 30, Time: 20, BuyGroup: "NylonRope", CraftGroup: "NylonRope", Audio: "RopeShort", Prerequisite: ["AccessTorso", "HasBreasts"], Extended: true, AllowTighten: true,
				DefaultColor: ["#CCCCCC"],
				Layer: [
					{ Name: "Rope" },
					{ Name: "Shine", AllowColorize: false },
			...
			{ Name: "LeatherStrapHarness", Gender: "F", Fetish: ["Leather"], BuyGroup: "LeatherStrapHarness", Value: 50, Difficulty: 50, Time: 15, RemoveTime: 10, DefaultColor: "#101010", AllowLock: true, Prerequisite: "AccessTorso", Attribute: ["CanAttachMittens"], },
			...
			{ Name: "Underbust", Fetish: ["Lingerie"], Priority: 22, Value: -1, Difficulty: 8, Time: 15, RemoveTime: 10, AllowLock: true, AllowTighten: true, DrawLocks: false, Left: 150, BuyGroup: "Underbust", Prerequisite: ["AccessTorso"], Expose: ["ItemNipples", "ItemBreast", "ItemNipplesPiercings"], HideForPose: ["Hogtied", "AllFours"], DynamicGroupName: "Corset" },
...

	{
		...
		Asset: [
			{ Name: "LockingSwimsuit", Gender: "F", Left: 150, Top: 200, Difficulty: 4, BuyGroup: "LockingSwimsuit", Value: 60, AllowLock: true, DrawLocks: false, Prerequisite: ["AccessTorso", "HasBreasts"], Extended: true },
			{ Name: "LeatherStrapHarness", Gender: "F", Fetish: ["Leather"], BuyGroup: "LeatherStrapHarness", Value: 50, Difficulty: 50, Time: 15, RemoveTime: 10, DefaultColor: "#101010", AllowLock: true, Prerequisite: ["AccessTorso", "HasBreasts"], Attribute: ["CanAttachMittens"], },
...

	{
		...
		Asset: [
			...
			{
				Name: "ShockClamps", Fetish: ["Metal", "Masochism"], Value: 60, Time: 10, Extended: true,
				AlwaysExtend: true, Prerequisite: ["AccessBreast"], HasType: false,
				ExpressionTrigger: [{ Name: "Closed", Group: "Eyes", Timer: 5 }, { Name: "Angry", Group: "Eyebrows", Timer: 10 }],
			},
			{
				Name: "PlateClamps", Fetish: ["Metal", "Masochism"], Value: 20, Time: 15, Extended: true,
				Prerequisite: ["AccessBreast"], HasType: false,
				ExpressionTrigger: [{ Name: "Closed", Group: "Eyes", Timer: 5 }, { Name: "Angry", Group: "Eyebrows", Timer: 10 }],
			},
			{
			...
			{
				Name: "NippleClamps2", Gender: "M", Prerequisite: ["AccessBreast", "HasFlatChest"], Fetish: ["Metal", "Masochism"], Value: 20, ParentGroup: null,
...

	{
		...
		Asset: [
			// Breast Only
			{ Name: "NylonRope", Fetish: ["Rope", "Nylon"], Value: 30, SelfBondage: 2, Time: 15, BuyGroup: "NylonRope", SetPose: ["BackBoxTie"], Effect: ["Block", "Prone"], Audio: "RopeShort", Extended: true, DynamicBeforeDraw: true, AllowTighten: true,
				DefaultColor: "#CCCCCC",
				Layer: [
					{ Name: "Rope" },
					{ Name: "Shine", AllowColorize: false }
			...
			{
				Name: "HempRope", Fetish: ["Rope"], Value: 60, Difficulty: 3, SelfBondage: 2, Time: 20, DefaultColor: "#956B1C", BuyGroup: "HempRope", Audio: "RopeShort", Extended: true, DynamicBeforeDraw: true, AllowTighten: true,
				SetPose: ["BackBoxTie"],
				Effect: ["Block", "Prone"],
				Layer: [
					{ Name: "" },
			...
			{ Name: "LeatherDeluxeCuffs", Fetish: ["Leather"], Priority: 29, Value: 50, Left: 0, Top: 0, Difficulty: 6, Time: 20, Random: false, AllowLock: true, DrawLocks: false, AllowTighten: true, AllowPose: ["BackBoxTie", "BackElbowTouch", "OverTheHead", "BackCuffs", "Yoked", "Hogtied"], Effect: ["CuffedArms"], Extended: true, HasType: false, Hide: ["Bracelet"], RemoveItemOnRemove: [{ Name: "X-Cross", Group: "ItemDevices" }],
			...
			{
				Name: "HighStyleSteelCuffs", Fetish: ["Metal"], Priority: 29, Value: 200, Left: 0, Top: 0, Difficulty: 6, Time: 20, Random: false, AllowLock: true, Audio: "CuffsMetal", AllowPose: ["BackBoxTie", "BackElbowTouch", "OverTheHead", "BackCuffs", "Yoked", "Hogtied"], Effect: ["CuffedArms"], Extended: true, HasType: false, Hide: ["Bracelet"], RemoveItemOnRemove: [{ Name: "X-Cross", Group: "ItemDevices" }],
				Layer: [
					{ Name: "Cuffs" },
					{ Name: "Panel" },
				],
			...
			{
				Name: "BitchSuit", Gender: "F", Fetish: ["Latex", "Pet"], Priority: 21, Value: 200, Difficulty: 12, SelfBondage: 8, Time: 40, RemoveTime: 30, Random: false, AllowLock: true, AllowTighten: true, Top: 150,
				...
				Hide: ["Shoes", "ItemBoots", "ItemLegs", "ItemFeet", "Gloves", "Hands", "LeftHand", "RightHand", "ItemHandheld", "ItemHands"],
				...
				Layer: [
					{ Name: "Latex", },
					{ Name: "Latex_Closed", AllowModuleTypes: ["z0", "z2"], CopyLayerColor: "Latex", },
					{ Name: "Zips", AllowModuleTypes: ["z0"], },
					{ Name: "Latex_Open", AllowModuleTypes: ["z1"], CopyLayerColor: "Latex", },
					{ Name: "Zips_Open", AllowModuleTypes: ["z1"], CopyLayerColor: "Zips", },
					{ Name: "Straps", AllowModuleTypes: ["st1"], },
					{ Name: "Buckles", AllowModuleTypes: ["st1"], },
					{ Name: "Lock", AllowModuleTypes: ["st1"], ParentGroup: null, LockLayer: true },
				],
				SelfUnlock: false
			},
			{
				...
				Layer: [
					{ Name: "Latex", },
					{ Name: "Latex_Closed", AllowTypes: ["Closed"], CopyLayerColor: "Latex", },
					{ Name: "Latex_Closed2", AllowTypes: ["Classic"], CopyLayerColor: "Latex", },
					{ Name: "Latex_Open", AllowTypes: ["Open"], CopyLayerColor: "Latex", },
					{ Name: "Zips", AllowTypes: [""], },
					{ Name: "Zips_Closed", AllowTypes: ["Closed"], CopyLayerColor: "Zips", },
					{ Name: "Zips_Closed2", AllowTypes: ["Classic"], CopyLayerColor: "Zips", },
					{ Name: "Zips_Open", AllowTypes: ["Open"], CopyLayerColor: "Zips", },
					{ Name: "Straps", AllowTypes: [""], },
					{ Name: "Straps_Closed", AllowTypes: ["Closed"], CopyLayerColor: "Straps", },
					{ Name: "Straps_Closed2", AllowTypes: ["Classic"], CopyLayerColor: "Straps", },
					{ Name: "Straps_Open", AllowTypes: ["Open"], CopyLayerColor: "Straps", },
					{ Name: "Buckles", AllowTypes: [""], },
					{ Name: "Buckles_Closed", AllowTypes: ["Closed"], CopyLayerColor: "Buckles", },
					{ Name: "Buckles_Closed2", AllowTypes: ["Classic"], CopyLayerColor: "Buckles", },
					{ Name: "Buckles_Open", AllowTypes: ["Open"], CopyLayerColor: "Buckles", },
					{ Name: "Lock", LockLayer: true, AllowTypes: ["Classic", "", "Open"], AllowColorize: true},
			...
			},
			{
				...
				HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetIrish8Cuffs", "ItemFeetHeavyAnkleCuffs", "ItemFeetDuctTape", "ItemFeetFuturisticAnkleCuffs", "ItemFeetFuturisticAnkleCuffs","ItemNipplesLactationPump", "ItemFeetChains", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper", "NecklaceBodyChainNecklace"],
				AllowPose: ["Kneel"],
			...
			{
				Name: "HeavyYoke", Fetish: ["Metal"], Priority: 39, Value: 80, Difficulty: 12, SelfBondage: 6, Time: 20, AllowLock: true, AllowTighten: true, HideItem: ["BraceletSpikeBands"], ParentGroup: null,
				SetPose: ["Yoked"],
				Effect: ["Block", "Prone", "NotSelfPickable"],
				Layer: [
					{ Name: "Frame" },
			...
			},
			{
				...
				Hide: ["BodyUpper", "BodyLower", "Cloth", "ClothLower", "Shoes", "Socks", "SocksRight", "SocksLeft", "ItemLegs", "ItemFeet", "ItemPelvis", "ItemBoots", "SuitLower", "Panties", "ItemVulva", "ItemVulvaPiercings", "Garters"],
			...
			{ Name: "HighSecurityStraitJacket", Value: 220, Priority: 25, Difficulty: 4, SelfBondage: 2, Time: 45, RemoveTime: 30, Random: false, AllowLock: true, DrawLocks: false, DefaultColor: ["#333", "#333", "#3e3e3e", "#3e3e3e"], AllowExpression: ["Hard"],
				Hide: ["Cloth", "ItemNipplesPiercings"],
				HideItem: ["NecklaceBodyChainNecklace"],
				SetPose: ["BackElbowTouch"],
				Effect: ["Block", "Prone"],
				...
				//PenisLayer denotes the player uses a penis
				//PussyLayer denotes the player uses a pussy
				//GenitaliaCover denotes a covered up penis by clothing or chastity belts
				//3 Attributes to show different cages, Plastic1 falls under CageTechno
					//Crotch, Male has 1 standard and 3 cage variants
					{ Name: "Crotch", ColorGroup: "Canvas", ParentGroup: null, ShowForAttribute: ["PussyLayer", "GenitaliaCover"], AllowModuleTypes: ["c1"], HasType: false },
					{ Name: "CrotchMale", CopyLayerColor: "Crotch", ParentGroup: null, ShowForAttribute: ["PenisLayer"], HideForAttribute: ["CagePlastic2", "CageTechno", "CageFlat"], AllowModuleTypes: ["c1"], HasType: false },
					{ Name: "CrotchMalePlastic2", CopyLayerColor: "Crotch", ParentGroup: null, ShowForAttribute: ["CagePlastic2"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["c1"], HasType: false },
					{ Name: "CrotchMaleTechno", CopyLayerColor: "Crotch", ParentGroup: null, ShowForAttribute: ["CageTechno"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["c1"], HasType: false },
					{ Name: "CrotchMaleFlat", CopyLayerColor: "Crotch", ParentGroup: null, ShowForAttribute: ["CageFlat"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["c1"], HasType: false },
					//Jacket
					...
					//Crotch Strap Single, Male has 1 standard and 3 cage variants
					{ Name: "CrotchStrapsSingle", ColorGroup: "Straps", ParentGroup: null, ShowForAttribute: ["PussyLayer", "GenitaliaCover"], AllowModuleTypes: ["s1"], HasType: false },
					{ Name: "CrotchStrapsSingleMale", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["PenisLayer"], HideForAttribute: ["CagePlastic2", "CageTechno", "CageFlat"], AllowModuleTypes: ["s1"], HasType: false },
					{ Name: "CrotchStrapsSingleMalePlastic2", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CagePlastic2"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s1"], HasType: false },
					{ Name: "CrotchStrapsSingleMaleTechno", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageTechno"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s1"], HasType: false },
					{ Name: "CrotchStrapsSingleMaleFlat", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageFlat"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s1"], HasType: false },
					//Crotch Strap Double, Male has 1 standard and 3 cage variants
					{ Name: "CrotchStrapsDouble", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["PussyLayer", "GenitaliaCover"], AllowModuleTypes: ["s2"], HasType: false },
					{ Name: "CrotchStrapsDoubleMale", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["PenisLayer"], HideForAttribute: ["CagePlastic2", "CageTechno", "CageFlat"], AllowModuleTypes: ["s2"], HasType: false },
					{ Name: "CrotchStrapsDoubleMalePlastic2", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CagePlastic2"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s2"], HasType: false },
					{ Name: "CrotchStrapsDoubleMaleTechno", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageTechno"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s2"], HasType: false },
					{ Name: "CrotchStrapsDoubleMaleFlat", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageFlat"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s2"], HasType: false },
					//Crotch Strap Triple, Male has 1 standard and 3 cage variants
					{ Name: "CrotchStrapsTriple", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["PussyLayer", "GenitaliaCover"], AllowModuleTypes: ["s3"], HasType: false },
					{ Name: "CrotchStrapsTripleMale", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["PenisLayer"], HideForAttribute: ["CagePlastic2", "CageTechno", "CageFlat"], AllowModuleTypes: ["s3"], HasType: false },
					{ Name: "CrotchStrapsTripleMalePlastic2", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CagePlastic2"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s3"], HasType: false },
					{ Name: "CrotchStrapsTripleMaleTechno", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageTechno"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s3"], HasType: false },
					{ Name: "CrotchStrapsTripleMaleFlat", CopyLayerColor: "CrotchStrapsSingle", ParentGroup: null, ShowForAttribute: ["CageFlat"], HideForAttribute: ["GenitaliaCover"], AllowModuleTypes: ["s3"], HasType: false },
					//Standard Penis
			...
			{ Name: "WrappedBlanket", Gender: "F", Extended: true, Value: -1, Difficulty: 15, SelfBondage: 3, Time: 40, RemoveTime: 30, Random: false, BuyGroup: "Bed", Prerequisite: ["NotSuspended", "NotHogtied", "NotKneelingSpread", "NoFeetSpreader", "HasBreasts"], Hide: ["Shoes", "Socks", "SocksRight", "SocksLeft", "Cloth", "ClothLower", "Bra", "ItemNipplesPiercings", "ItemLegs", "Garters"], HideItem: ["ItemFeetOrnateAnkleCuffs", "HighStyleSteelAnkleCuffs", "ItemFeetNylonRope", "ItemFeetHempRope", "ItemFeetLeatherBelt", "ItemFeetIrish8Cuffs", "ItemFeetHeavyAnkleCuffs", "ItemFeetDuctTape", "ItemFeetLeatherAnkleCuffs", "ItemFeetLeatherDeluxeAnkleCuffs", "ItemNipplesLactationPump", "PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper"], AllowPose: ["Kneel"], SetPose: ["BackElbowTouch", "LegsClosed"], Effect: ["Block", "Prone"], Block: ["ItemPelvis", "ItemTorso", "ItemTorso2", "ItemBreast", "ItemHands", "ItemHandheld", "ItemFeet", "ItemNipples", "ItemNipplesPiercings", "ItemVulva", "ItemVulvaPiercings", "ItemLegs", "ItemButt"], },
			...
			{ Name: "SleepSac", Gender: "F", Fetish: ["Latex"], Value: 150, Difficulty: 10, SelfBondage: 6, Time: 30, RemoveTime: 40, Left: 0, Top: 0, AllowLock: true, AllowTighten: true, DrawLocks: false, Random: false,
				...
				Hide: ["Cloth", "Suit", "ClothLower", "SuitLower", "Shoes", "BodyLower", "Socks", "SocksRight", "SocksLeft", "Panties", "ItemPelvis", "Garters", "LeftHand", "RightHand", "ItemBoots", "ItemLegs", "ItemFeet", "ItemButt", "TailStraps", "Wings"],
				HideItem: ["PantiesPoofyDiaper", "PantiesBulkyDiaper", "ItemPelvisPoofyDiaper", "ItemPelvisBulkyDiaper", "ClothAccessoryPoncho"],
				SelfUnlock: false,
			...
			},
			{
				...
				Hide: ["ItemVulva", "LeftHand", "RightHand", "Cloth", "Panties", "Bra"], AllowPose: ["Kneel", "LegsClosed", "KneelingSpread"],
...

	{
		...
		Asset: [
			{
				Name: "PaddedMittens", Fetish: ["ABDL"], Value: 40, Difficulty: 4, SelfBondage: 2, Time: 15, AllowLock: true,
				DefaultColor: "#bbbbbb", AllowPose: ["OverTheHead", "BackBoxTie", "BackElbowTouch", "BackCuffs", "Yoked", "AllFours"],
				Effect: ["Block", "Prone", "MergedFingers"],
				Hide: ["LeftHand", "RightHand", "ItemHandheld"], HideItem: ["BraceletSpikeBands"],
				Extended: true, AllowColorize: true, HasType: false, ParentGroup: null,
				Layer: [
					{ Name: "Gloves", },
					{ Name: "Straps", },
					{ Name: "Buckles", },
			...
			{
				Name: "PawMittens", Gender: "F", Prerequisite: ["HasBreasts"], Fetish: ["ABDL", "Pet"], Value: 50, Difficulty: 4, SelfBondage: 1, Time: 15, AllowLock: true,
				DefaultColor: ["#bbbbbb","#bbbbbb","#bbbbbb","#B38295"],
	...
	},
	{
		...
		Asset: [
			...
			},
			{
				...
				ActivityExpression: {
					"SpankItem": [{ Group: "Blush", Name: "Medium", Timer: 10 }, { Group: "Eyebrows", Name: "Soft", Timer: 10 }, { Group: "Eyes", Name: "Closed", Timer: 5 }],
				}
			},
			{
			...
			},
			{
				...
				HideForPose: ["BackBoxTie", "BackCuffs", "BackElbowTouch", "OverTheHead", "Yoked"],
...

	{
		...
		Asset: [
			...
			{ Name: "SlaveCollar", Value: -1, Difficulty: 50, Time: 5, Enable: false, Random: false, OwnerOnly: true, Effect: ["Lock"], AllowBlock: ["ItemMouth", "ItemMouth2", "ItemMouth3"], AllowEffect: ["GagNormal", "FixedHead"], AllowType: ["SteelPosture", "LeatherPosture", "PetCollar", "HighCollar", "LeatherCollarBell", "LeatherCollarBow", "LeatherDeluxeCollar", "MaidCollar", "BatCollar", "HighSecurityCollar", "SpikeCollar", "BordelleCollar", "LeatherCorsetCollar", "StrictPostureCollar", "LatexPostureCollar", "HeartCollar", "NobleCorsetCollar", "OrnateCollar", "HighStyleSteelCollar", "LoveLeatherCollar", "SlenderSteelCollar", "ShinySteelCollar", "HeartLinkChoker", "NeckRope"], Extended: true },
			...
			{ Name: "LeatherDeluxeCollar", Fetish: ["Leather"], DefaultColor: ["Default", "#612C2C", "Default"], Value: 50, Difficulty: 50, Time: 5, AllowLock: true, DrawLocks: false, Layer: [
				{ Name: "Collar"},
				{ Name: "Rings"},
				{ Name: "Buckets"},
				{ Name: "Lock", LockLayer: true, AllowColorize: true },
...

	{
		...
		Asset: [
			...
			},
			{
				...
				PoseMapping: { AllFours: "Hogtied" }, DynamicBeforeDraw: true, Effect: ["Leash"], AllowEffect: ["Leash", "Block", "IsLeashed"],
				Layer: [
					{ Name: "Leash" },
					{ Name: "Handle" },
					{ Name: "Clip" },
...

	{
		...
		Asset: [
			...
			{ Name: "PacifierGag", Category: ["ABDL"], Fetish: ["ABDL", "Leather"], Value: 10, Difficulty: -50, Time: 2, Random: false, Hide: ["Mouth"], Effect: ["BlockMouth", "GagVeryLight"], Block: ["ItemMouth2", "ItemMouth3"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }] },
			{
				Name: "HarnessPacifierGag", Category: ["ABDL"], Fetish: ["ABDL", "Leather"], Value: 50, Difficulty: 6, Time: 20, Random: false, AllowLock: true, AllowTighten: true, BuyGroup: "HarnessPacifierGag", Prerequisite: "GagUnique", Hide: ["Mouth"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }],
				Layer: [
					{ Name: "Harness" },
					{ Name: "Metal" },
					{ Name: "PacifierOuter" },
			...
			{ Name: "ChloroformCloth", Value: 40, Time: 2, Random: false, Hide: ["Mouth"], HideItem: ["ItemNoseNoseRing"], Effect: ["BlockMouth", "GagVeryLight"], ExpressionTrigger: [{ Name: "High", Group: "Blush", Timer: 20 }, { Name: "Soft", Group: "Eyebrows", Timer: 180 }, { Name: "Closed", Group: "Eyes", Timer: 180 }] },
			...
			{ Name: "LewdGag", Value: 70, Time: 10, Random: false, AllowLock: true, BuyGroup: "LewdGag", Prerequisite: "GagFlat", Hide: ["Mouth"], HideItem: ["ItemNoseNoseRing"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }] },
			...
			{ Name: "MilkBottle", Category: ["ABDL"], Fetish: ["ABDL"], Priority: 42, Value: 30, Difficulty: -50, Time: 1, Random: false, AllowLock: false, Left: 199, Top: 0, Prerequisite: "GagUnique", Effect: ["GagVeryLight", "ProtrudingMouth"], Block: ["ItemMouth2", "ItemMouth3"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }], ParentGroup: null, Extended: true },
			{
			...
			{
				Name: "PaciGag", Category: ["ABDL"], Fetish: ["ABDL", "Leather"], Value: 50, Difficulty: 4, Time: 10, Random: false, BuyGroup: "Pacigag", AllowLock: true, AllowTighten: true, DrawLocks: false, Prerequisite: "GagUnique", Hide: ["Mouth"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }],
				Layer: [
					{ Name: "Base" },
					{ Name: "Straps" },
					{ Name: "Metal" },
...

	{
		...
		Asset: [
			...
			{
				Name: "HarnessPacifierGag", Category: ["ABDL"], Fetish: ["ABDL", "Leather"], Value: -1, Difficulty: 6, Time: 20, Random: false, AllowLock: true, AllowTighten: true, BuyGroup: "HarnessPacifierGag", Prerequisite: "GagUnique", Hide: ["Mouth"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }],
				Layer: [
					{ Name: "Harness" },
					{ Name: "Metal" },
					{ Name: "PacifierOuter" },
			...
			{ Name: "ChloroformCloth", Value: -1, Time: 2, Random: false, BuyGroup: "ChloroformCloth", Prerequisite: "GagFlat", Hide: ["Mouth"], HideItem: ["ItemNoseNoseRing"], Effect: ["BlockMouth", "GagVeryLight"], ExpressionTrigger: [{ Name: "High", Group: "Blush", Timer: 20 }, { Name: "Soft", Group: "Eyebrows", Timer: 180 }, { Name: "Closed", Group: "Eyes", Timer: 180 }] },
			...
			{ Name: "LewdGag", Value: -1, Time: 10, Random: false, AllowLock: true, BuyGroup: "LewdGag", Prerequisite: "GagFlat", Hide: ["Mouth"], HideItem: ["ItemNoseNoseRing"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }], },
			...
			{ Name: "Ribbons", Value: 30, Difficulty: 3, Time: 10, BuyGroup: "Ribbon", Prerequisite: "GagFlat", Effect: ["BlockMouth", "GagVeryLight"], ExpressionTrigger: [{ Name: "DroolSides", Group: "Fluids", Timer: 30 }, { Name: "HalfOpen", Group: "Mouth", Timer: 60 }], Extended: true },
			{
				Name: "PaciGag", Category: ["ABDL"], Fetish: ["ABDL", "Leather"], Value: -1, Difficulty: 4, Time: 10, Random: false, BuyGroup: "Pacigag", AllowLock: true, AllowTighten: true, DrawLocks: false, Prerequisite: "GagUnique", Hide: ["Mouth"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }],
				Layer: [
					{ Name: "Base" },
					{ Name: "Straps" },
					{ Name: "Metal" },
...

	{
		...
		Asset: [
			...
			{ Name: "LewdGag", Value: -1, Time: 10, Random: false, AllowLock: true, BuyGroup: "LewdGag", Hide: ["Mouth"], HideItem: ["ItemNoseNoseRing"], Effect: ["BlockMouth", "GagLight"], ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }], },
			...
			}, //PonyGag 3
			{
				...
				Layer: [
					{ Name: "FakeMouth", HasType: false, InheritColor: "Mouth", AllowTypes: ["", "ZigZag", "Skewed", "Cross"], MirrorExpression: "Mouth"},
					{ Name: "Straight", HasType: false, AllowTypes: [""], MirrorExpression: "Mouth"},
			...
			},
			{
				...
				Layer:[
					...
					{Name: "BaseThin", AllowModuleTypes: ["t0"]},
					{Name: "BaseThick", AllowModuleTypes: ["t1"], CopyLayerColor: "BaseThin"},
					{Name: "Heart", AllowModuleTypes: ["p2"]},
					{Name: "Lips", AllowModuleTypes: ["p1"], CopyLayerColor: "Heart"},
				],
				DynamicGroupName: "ItemMouth3",
			},
		],
...

	{
		...
		Asset: [
			...
			{ Name: "LewdBlindfold", Priority: 30, Value: 45, Time: 5, Random: false, AllowLock: true, AllowTighten: true, Hide: ["Glasses", "Mask"], Effect: ["BlindLight", "Prone"], Audio: "ClothSlip",  ExpressionTrigger: [{ Name: "Low", Group: "Blush", Timer: 5 }, { Name: "Closed", Group: "Eyes", Timer: 5 }] },
	...
	},
	{
		...
		Asset: [
			...
			{
				Name: "LatexHabit", Fetish: ["Latex"], BuyGroup: "LatexHabit", Top: 23, Left: 85, Value: 30, Time: 5, AllowLock: true, AllowTighten: true, HasType: false, HideItem: ["ItemEarsFuturisticEarphones"], Hide: ["HairFront","FacialHair", "HairBack", "Hat", "HairAccessory1", "HairAccessory2", "HairAccessory3",], Block: ["ItemEars"],
				Layer:[
					{Name: "Cape", AllowTypes: [""]},
					{Name: "CapeThin", AllowTypes: ["Tight"], CopyLayerColor: "Cape"},
					{Name: "Base", AllowTypes: [""]},
			...
			},
			{
				...
				AllowLock: true, Extended: true, DrawLocks: false, HasType: false,
				...
				Layer: [
					...
					{ Name: "BlindfoldUwU", Top: 80, Left: 164, AllowModuleTypes: ["b1e2"], CopyLayerColor: "Drawings", },
					{ Name: "Gag", Top: 80, Left: 164, AllowModuleTypes: ["g1"], AllowColorize: false, },
					{ Name: "GagNeutral", Top: 80, Left: 164, AllowModuleTypes: ["g1e0"], CopyLayerColor: "Drawings", },
					{ Name: "GagOwO", Top: 80, Left: 164, AllowModuleTypes: ["g1e1"], CopyLayerColor: "Drawings", },
			...
			},
			{
				...
				Layer: [
					{Name: "Thick", HasType: false, AllowTypes: [""]},
			...
			{
				Name: "OpenMouthPlugHood", Fetish: ["Latex"], Random: false, Value: 40, Difficulty: 3, Top: 52, DrawLocks: false, AllowLock: true, AllowTighten: true, Extended: true, HasType: false,
				Hide: ["HairFront", "FacialHair", "HairBack", "Glasses", "HairAccessory1", "HairAccessory2", "HairAccessory3"],
			...
			},
			{
				...
				Layer: [
					...
					{ Name: "PanelCircleEye", HasType: false, AllowModuleTypes: ["e24","e26","e27"], CopyLayerColor: "PanelNoEye" },
					{ Name: "PanelCircleEyeTransparent", HasType: false, AllowModuleTypes: ["e25","e28","e29"], CopyLayerColor: "PanelNoEye" },
					{ Name: "PanelCircleEyeHighlight", HasType: false, AllowModuleTypes: ["e24","e26","e27","e25","e28","e29"], CopyLayerColor: "PanelHeadHighlight" },
					...
					{ Name: "FillCircleEye", HasType: false, AllowModuleTypes: ["e26","e28"], CopyLayerColor: "FillRoundEye" },
					{ Name: "FillCircleEyeTransparent", HasType: false, AllowModuleTypes: ["e27","e29"], CopyLayerColor: "FillRoundEye" },
					...
					{ Name: "PanelFishnetMouth", HasType: false, AllowModuleTypes: ["m25"], CopyLayerColor: "PanelNoMouth" },
					{ Name: "PanelCircleMouth", HasType: false, AllowModuleTypes: ["m26","m28","m30"], CopyLayerColor: "PanelNoMouth" },
					{ Name: "PanelCircleMouthTransparent", HasType: false, AllowModuleTypes: ["m27","m29","m31"], CopyLayerColor: "PanelNoMouth" },
					{ Name: "PanelCircleMouthHighlight", HasType: false, AllowModuleTypes: ["m26","m28","m30","m27","m29","m31"], CopyLayerColor: "PanelHeadHighlight" },
					...
					{ Name: "FillCircleMouth", HasType: false, AllowModuleTypes: ["m28","m29"], CopyLayerColor: "FillRoundMouth" },
					{ Name: "FillCircleMouthTransparent", HasType: false, AllowModuleTypes: ["m30","m31"], CopyLayerColor: "FillRoundMouth" },
					...
					{ Name: "LiningCircleEyeHighlight", HasType: false, AllowModuleTypes: ["e24","e26","e27","e25","e28","e29"], CopyLayerColor: "PanelHeadHighlight" },
					{ Name: "LiningCircleMouth", HasType: false, AllowModuleTypes: ["m26","m28","m30","m27","m29","m31"], CopyLayerColor: "LiningRoundMouth" },
					...
					{ Name: "ZipperHoodOpenZipper", Priority: 50, HasType: false, AllowModuleTypes: ["z1","z3"], ColorGroup: "HoodCoverParts" }, // master colour for hood cover zipper
			...
			},
			{
				...
				Layer: [
					{Name: "Base", Alpha: [{ Masks: [[0, 160, 400, 200]], Group: ["Head"] }],},
					{Name: "Metal", },
					{Name: "Lens", AllowModuleTypes: ["l2"]},
...

	{
		...
		Asset: [
			...
			{ Name: "FamilyPadlock", Value: 50, Time: 10, Wear: false, FamilyOnly: true, Effect: [], IsLock: true},
			...
			{ Name: "FamilyPadlockKey", Value: 30, Wear: false, FamilyOnly: true, Effect: ["Unlock-FamilyPadlock"] },
			...
			{ Name: "MetalCuffsKey", Value: 20, Time: 5, Wear: false, Effect: ["Unlock-MetalCuffs", "Unlock-EscortAnkleCuffs"] },
...

	{
		...
		Asset: [
			...
			{ Name: "InflatableBodyBag", Fetish: ["Latex"], Priority: 31, Value: 225, Difficulty: 1, SelfBondage: 6, Time: 30, RemoveTime: 50, AllowLock: true, AllowTighten: true, Audio: "Bag", Prerequisite: ["NotSuspended", "AllFours", "NotHogtied", "NotYoked", "NotMounted", "NotKneelingSpread", "NoFeetSpreader"], Hide: ["Cloth", "Suit", "ClothLower", "SuitLower", "Shoes", "ItemBoots", "ItemLegs", "ItemFeet", "ItemArms", "ItemButt", "TailStraps", "Wings", "BodyLower", "Socks", "SocksRight", "SocksLeft", "ItemNipplesPiercings", "Panties", "ItemPelvis", "Garters", "LeftHand", "RightHand"], HideItem: ["ItemVulvaFullLatexSuitWand", "ItemNipplesLactationPump", "ClothAccessoryPoncho"], AllowPose: ["Kneel"], SetPose: ["LegsClosed", "BackElbowTouch"], Effect: ["Block", "Prone", "Freeze"], Block: ["ItemArms", "ItemBreast", "ItemButt", "ItemFeet", "ItemHands", "ItemHandheld", "ItemLegs", "ItemMisc", "ItemNipples", "ItemNipplesPiercings", "ItemPelvis", "ItemTorso", "ItemTorso2", "ItemVulva", "ItemVulvaPiercings", "ItemBoots"], Extended: true, SelfUnlock: false, AllowActivePose: ["Kneel"] },
			{
				...
				Alpha: [{ Masks: [[0, 0, 500, 900]], Group: ["SuitLower", "Shoes", "ItemBoots", "ItemFeet", "BodyLower", "Socks", "SocksRight", "SocksLeft"] }],
			...
			{
				Name: "OneBarPrison", Gender: "F", Fetish: ["Metal"], Priority: 16, Value: 75, Difficulty: 8, SelfBondage: 2, Time: 20, AllowLock: true, Prerequisite: ["AccessVulva", "AllFours", "LegsOpen", "NotSuspended", "NotHogtied", "NotHorse", "NotKneeling", "NotChaste", "HasVagina"], SetPose: ["LegsOpen"], Effect: ["FillVulva", "Prone", "Freeze", "Mounted", "VulvaShaft"], Block: ["ItemLegs", "ItemVulva", "ItemFeet"], AllowActivityOn: ["ItemLegs", "ItemFeet"], Layer: [
			...
			{ Name: "WoodenStocks", Value: 150, Difficulty: 50, SelfBondage: 4, Time: 10, AllowLock: true, Prerequisite: ["NotKneeling", "AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread", "NoItemArms", "LegsOpen"], SetPose: ["Yoked", "LegsOpen"], Effect: ["Prone", "Freeze", "Block", "Mounted"], Block: ["ItemArms", "ItemFeet", "ItemLegs", "ItemBoots"], AllowActivityOn: ["ItemArms", "ItemFeet", "ItemLegs", "ItemBoots"],RemoveAtLogin: true, HideItem: ["ItemMiscTeddyBear"], },
			{
				...
				Prerequisite: ["NotKneeling", "AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread", "NoItemArms", "LegsOpen", "NoItemHands", "NoItemLegs", "NotHorse", "NoItemFeet", "HasBreasts"],
			...
			},
			{
				...
				Hide: ["Hands", "HairBack", "Cloth", "ClothLower", "ClothAccessory", "Necklace", "Suit", "SuitLower", "Bra", "Panties", "Socks", "SocksRight", "SocksLeft", "RightAnklet", "LeftAnklet", "Shoes", "Gloves", "TailStraps", "Wings", "ItemFeet", "ItemLegs", "ItemVulva", "ItemVulvaPiercings", "ItemButt", "ItemPelvis", "ItemTorso", "ItemTorso2", "ItemNipples", "ItemNipplesPiercings", "ItemBreast", "ItemArms", "ItemHands", "ItemHandheld", "ItemBoots", "Pussy", "Corset", "Bracelet", "Garters", "LeftHand" ,"RightHand"],
				HideItem: ["ItemMiscTeddyBear"],
				Prerequisite: ["NotKneeling", "AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread", "NoItemArms", "NoItemHands", "NoItemLegs", "NotHorse", "NoItemFeet", "HasBreasts"],
			...
			},
			{
				...
				Prerequisite: ["NoItemArms", "NoItemLegs", "AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread", "NotYoked", "LegsOpen", "NotHorse", "NoItemFeet", "HasBreasts"],
				Hide: ["BodyLower", "Hands", "HairBack", "Cloth", "ClothLower", "ClothAccessory", "Necklace", "Suit", "SuitLower", "Bra", "Panties", "Socks", "SocksRight", "SocksLeft", "RightAnklet", "LeftAnklet", "Shoes", "Gloves", "TailStraps", "Wings", "ItemFeet", "ItemLegs", "ItemVulva", "ItemVulvaPiercings", "ItemButt", "ItemPelvis", "ItemTorso", "ItemTorso2", "ItemNipples", "ItemNipplesPiercings", "ItemBreast", "ItemArms", "ItemHands", "ItemHandheld", "ItemBoots", "Pussy", "Corset", "Bracelet", "LeftHand" ,"RightHand"],
				HideItem: ["ItemMiscTeddyBear"],
				SetPose: ["BaseUpper", "BaseLower"],
			...
			},
			{
				...
				FixedPosition: true,
				Layer: [
					{ Name: "Paper1", Priority: 71, MinOpacity: 1, AllowTypes: [""], },
					{ Name: "Frame1", Priority: 72, MinOpacity: 1, AllowTypes: [""], },
...

	{
		...
		Asset: [
			...
			{ Name: "ToeCuffs", Fetish: ["Metal"], Value: 35, Difficulty: 4, Time: 10, RemoveTime: 5, AllowLock: true, DrawLocks: false, Prerequisite: ["CanCloseLegs"], Audio: "LockSmall", ParentGroup: null, SetPose: ["LegsClosed"], Effect: ["Freeze", "Prone"], AllowActivePose: ["Kneel"], FreezeActivePose: ["BodyLower"], HideForPose: ["Spread", "KneelingSpread"] },
			{ Name: "LeatherToeCuffs", Fetish: ["Leather"], Value: 50, Difficulty: 3, Time: 10, RemoveTime: 5, AllowLock: true, DrawLocks: false, AllowTighten: true, Prerequisite: ["CanCloseLegs"], ParentGroup: null, SetPose: ["LegsClosed"], Effect: ["Freeze", "Prone"], AllowActivePose: ["Kneel"], FreezeActivePose: ["BodyLower"], HideForPose: ["Spread", "KneelingSpread"] },
			{ Name: "ToeTie", Fetish: ["Rope"], Value: 15, Difficulty: 2, Time: 10, RemoveTime: 5, AllowTighten: true, DefaultColor: "#956B1C", CraftGroup: "HempRope", Prerequisite: ["CanCloseLegs"], Audio: "RopeShort", ParentGroup: null, SetPose: ["LegsClosed"], Effect: ["Freeze", "Prone"], AllowActivePose: ["Kneel"], FreezeActivePose: ["BodyLower"], HideForPose: ["Spread", "KneelingSpread"] },
			...
			{ Name: "ToeTape", Fetish: ["Tape"], Extended: true, Value: 50, BuyGroup: "DuctTape", CraftGroup: "DuctTape", Audio: "DuctTape", Difficulty: 2, Time: 10, RemoveTime: 5, Prerequisite: ["CanCloseLegs"], ParentGroup: null, SetPose: ["LegsClosed"], AllowActivePose: ["Kneel"], HideForPose: ["Spread", "KneelingSpread"] },
			{ Name: "Zipties", Value: 20, Difficulty: 6, Time: 5, RemoveTime: 6, BuyGroup: "Zipties", Audio: "ZipTie", Prerequisite: ["CanCloseLegs"], ParentGroup: null, SetPose: ["LegsClosed"], Effect: ["Freeze", "Prone"], AllowActivePose: ["Kneel"], HideForPose: ["Spread", "KneelingSpread"] },
			...
			},
			{
				...
				Alpha: [
					{ Group: ["BodyLower", "Socks", "SocksRight", "SocksLeft", "SuitLower"], Masks: [[175, 835, 150, 165]] },
				],
				Layer: [
					{ Name: "Binder" },
...
var PoseFemale3DCG = [
	...
	},
	{
		...
		MovePosition: [{ Group: "Socks", X: 0, Y: -400 }, { Group: "SocksRight", X: 0, Y: -400 }, { Group: "SocksLeft", X: 0, Y: -400 }, { Group: "Shoes", X: 0, Y: -500 }, { Group: "ItemBoots", X: 0, Y: -500 }, { Group: "SuitLower", X: 0, Y: -380 }, { Group: "TailStraps", X: 0, Y: -300 }, { Group: "ItemButt", X: 0, Y: -300 }]
	},
	{
		Name: "Suspension",
	...
	},
	{
		...
		Hide: ["ItemFeet", "ClothLower", "SuitLower", "Nipples", "Pussy", "BodyLower", "Wings", "ItemPelvis", "ItemVulva", "ItemVulvaPiercings", "ItemLegs", "ItemBoots", "Suit", "Panties", "Bra", "Socks", "SocksRight", "SocksLeft", "Shoes", "LeftAnklet", "RightAnklet", "Garters", "Bracelet"],
