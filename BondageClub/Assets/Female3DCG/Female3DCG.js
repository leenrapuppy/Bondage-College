...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "PantyhoseBodyOpen", Fetish: ["Nylon"], Value: 75, Priority: 15, Difficulty: 3, SelfBondage: 4, Time: 30, RemoveTime: 20, Random: false, BuyGroup: "PantyhoseBody", AllowPose: ["Kneel"], SetPose: ["BackElbowTouch", "LegsClosed"], Effect: ["Block", "Prone", "Slow"],
				Prerequisite: ["NotHogtied", "NotMounted", "NoFeetSpreader"], Hide: ["Cloth", "ClothLower", "Suit", "SuitLower", "Garters"], Block: ["ItemHands",  "ItemNipplesPiercings"], AllowActivePose: ["Kneel"] },
...

	{
		...
		Asset: [
			...
			{
				Name: "PonyGag", Fetish: ["Leather", "Pony", "Pet"], Value: 150, Difficulty: 4, Time: 20, Random: false, AllowLock: true, BuyGroup: "PonyGag", Prerequisite: "GagUnique", DefaultColor: ["Default", "Default", "Default", "#EAEAEA", "Default", "FF89D8", "Default","Default"], Extended: true, AlwaysExtend: true, Effect: ["BlockMouth", "GagLight"], Bonus: "KidnapBruteForce", Top: -57, Left: 133,
				Layer: [
				// Layers: Metal, Straps, Plume, Horn, Panel
					...
					//{ Name: "LargeBit", HasType: false, AllowModuleTypes: ["g2"] },	
					//{ Name: "DildoMetal", HasType: false, AllowModuleTypes: ["g3"], AllowColorize: false },
					//{ Name: "Dildo", HasType: false, AllowModuleTypes: ["g3"] },
					
					//ExtraStraps
					{ Name: "ExtraMetal", HasType: false, AllowColorize: false, AllowModuleTypes: ["e1", "p1", "p2","p3" ,"p4" ,"p5" ,"p6" ,"p7" ,"p8"], Priority: 55 },
					{ Name: "ExtraStraps", HasType: false, CopyLayerColor: "Straps", AllowModuleTypes: ["e1", "p1", "p2","p3" ,"p4" ,"p5" ,"p6" ,"p7" ,"p8"], Priority: 55  },
					...
					{ Name: "PanelHex", HasType: false, AllowModuleTypes: ["p2"],Priority: 58 },
					...
					//{ Name: "Chains", HasType: false, AllowModuleTypes: ["r3"], CopyLayerColor: "Reins" },	
