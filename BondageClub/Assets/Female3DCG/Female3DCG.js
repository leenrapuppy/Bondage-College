...
var AssetFemale3DCG = [
	...
	// Appearance specific
	{
		...
		Asset: [
			...
			{
				Name: "SlaveRags", Value: 0, BuyGroup: "SlaveRags", Extended: true, AllowPose: ["AllFours", "TapedHands", "BackBoxTie", "BackCuffs", "BackElbowTouch", "Yoked", "Hogtied", "OverTheHead"], DefaultColor: ["#886D5D", "#886D58"],
				Layer: [
