...
var AssetFemale3DCG = [
	...
	},
	{
		...
		Asset: [
			...
			{
				Name: "CollarHood", Fetish: ["Latex"], Top: 21, Left: 150, Value: 50, AllowLock: true, AllowTighten: true, Time: 17, HideItem: ["ItemEarsFuturisticEarphones"], Hide: ["HairFront", "FacialHair", "HairBack", "Hat", "HairAccessory1", "HairAccessory2", "HairAccessory3", "Mask"], Layer: [
					{ Name: "Hood" },
					{ Name: "Collar" },
				],
				Alpha: [{ Group: ["Head"], Masks: [[0, 0, 212, 260], [290, 0, 205, 260]] }]
			...
			},
			{
				...
				Layer: [
					{ Name: "Base", HasType: false, AllowModuleTypes: ["t0"] },
					{ Name: "BaseThin", HasType: false, CopyLayerColor: "Base", AllowModuleTypes: ["t1"], Alpha: [{ Group: ["Head"], Masks: [[0, 0, 212, 260], [287, 0, 205, 260]] }]},
					{ Name: "Linings", HasType: false, AllowModuleTypes: ["t0"] },
					{ Name: "Liningsthin", HasType: false, CopyLayerColor: "Linings", AllowModuleTypes: ["t1"] },
					{ Name: "Panel", HasType: false, AllowModuleTypes: ["t0"] },
					{ Name: "PanelThin", HasType: false, CopyLayerColor: "Panel", AllowModuleTypes: ["t1"] },
					{ Name: "Display", HasType: false, AllowModuleTypes: ["t0"] },
					{ Name: "DisplayThin", HasType: false, CopyLayerColor: "Display", AllowModuleTypes: ["t1"] },
					{ Name: "Openings", HasType: false, AllowModuleTypes: ["t0"] },
					{ Name: "OpeningsThin", HasType: false, CopyLayerColor: "Openings", AllowModuleTypes: ["t1"] },
					...
					{ Name: "Lock", Top: 113, Left: 233, HasType: false, LockLayer: true, AllowColorize: true, AllowModuleTypes: ["t0"] },
					{ Name: "LockThin", HasType: false, LockLayer: true, CopyLayerColor: "Lock", AllowModuleTypes: ["t1"] },
				],
			},
			{
